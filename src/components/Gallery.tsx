...
const stackConfigMobile = [
  { zIndex: 30, translate: "translate(0, 0)", rotate: "rotate(0deg)", scale: 1, opacity: 1 },
  { zIndex: 20, translate: "translate(6px, 5px)", rotate: "rotate(2deg)", scale: 0.97, opacity: 0.5 },
  { zIndex: 10, translate: "translate(12px, 10px)", rotate: "rotate(-1.5deg)", scale: 0.94, opacity: 0.3 },
];
...
const Gallery = () => {
  ...
  return (
    <section ref={sectionRef} id="gallery" className="py-20 bg-background" aria-label="Gallery">
        ...
        {isOpen && (
          ...
          >
            ...
            <div ref={emblaRef} className="overflow-hidden rounded-2xl">
              <div className="flex">
                {images.map((img, i) => (
                  <div key={i} className="flex-[0_0_100%] min-w-0 sm:flex-[0_0_50%] lg:flex-[0_0_33.333%] pl-4 first:pl-0">
