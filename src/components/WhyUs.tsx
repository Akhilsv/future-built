...
const reasons = [
  {
    ...
    description:
      "Trainers bring a wealth of academic expertise and extensive industrial exposure, delivering programs to numerous corporates.",
  },
  {
    image: iconOutcome,
    title: "Outcome-Driven Training",
    description:
      "Our training focuses on real-world applications with measurable progress assessments throughout the journey.",
  },
  {
    image: iconIntegrity,
    title: "Integrity & Innovation",
    description:
      "Trust and faith amongst ourselves and with our clients keep us excited and encourage continuous improvement.",
  },
  {
    image: iconTransparency,
    title: "Transparency & Relationships",
    description:
      "We adapt to change, stay goal-focused, and apply our knowledge to new challenges with a corporate mindset.",
  },
];
...
const WhyUs = () => {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(180deg, hsl(210 40% 97%) 0%, hsl(216 30% 95%) 100%)",
      }}
    >
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div
          ...
          role="list"
          aria-label="Core Hexis differentiators"
        >
          {reasons.map((item, i) => (
            <motion.article
              key={item.title}
